package com.appmagnet.fintaskanyplace.wunderlist;
...
public class LoginWebClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(final WebView view, final String urlStr) {
           ...
           if (urlStr.startsWith(ApiKeys.REDIRECT_URI)) {
    ...
    private LoginWebClient webClient;
        ...
        protected String doInBackground(Object... params) {
            try {
                ...
                jsonObject.accumulate("client_id", ApiKeys.CLIENT_ID);
                jsonObject.accumulate("client_secret", ApiKeys.CLIENT_SECRET);
